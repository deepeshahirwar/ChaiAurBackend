  ...
  return ( 
    ...
    <div className="min-h-screen bg-gradient-to-r from-blue-300 to-blue-600 p-8">  
     ...
     <GoBackButton /> {/* Add the GoBackButton component here */}
      ...
      <h1 className="text-4xl font-bold text-white text-center">Completed Todos</h1>
      <p className="text-lg text-white text-center mt-2">Here you can find all your completed tasks.</p>

      <div className="mt-8 max-w-2xl mx-auto space-y-4">
        {completedTodos.length === 0 ? (
          <p className="text-white text-center">No completed todos yet.</p>
        ) : (
